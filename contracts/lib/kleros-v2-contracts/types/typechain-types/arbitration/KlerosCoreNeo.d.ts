...
export interface KlerosCoreNeoInterface extends Interface {
    getFunction(nameOrSignature: "addNewDisputeKit" | "appeal" | "appealCost" | "appealPeriod" | "arbitrableWhitelist" | "arbitrationCost(bytes,address)" | "arbitrationCost(bytes)" | "changeAcceptedFeeTokens" | "changeArbitrableWhitelist" | "changeCourtParameters" | "changeCurrencyRates" | "changeGovernor" | "changeGuardian" | "changeJurorNft" | "changeJurorProsecutionModule" | "changePinakion" | "changeSortitionModule" | "convertEthToTokenAmount" | "courts" | "createCourt" | "createDispute(uint256,bytes)" | "createDispute(uint256,bytes,address,uint256)" | "currencyRates" | "currentRuling" | "disputeKits" | "disputes" | "draw" | "enableDisputeKits" | "execute" | "executeGovernorProposal" | "executeRuling" | "getDisputeKitsLength" | "getNumberOfRounds" | "getNumberOfVotes" | "getPnkAtStakePerJuror" | "getRoundInfo" | "getTimesPerPeriod" | "governor" | "guardian" | "initialize" | "initialize5" | "isDisputeKitJumping" | "isSupported" | "jurorNft" | "jurorProsecutionModule" | "passPeriod" | "pause" | "paused" | "pinakion" | "proxiableUUID" | "setStake" | "setStakeBySortitionModule" | "sortitionModule" | "transferBySortitionModule" | "unpause" | "upgradeToAndCall" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "arbitrableWhitelist", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "changeArbitrableWhitelist", values: [AddressLike, boolean]): string;
    ...
    encodeFunctionData(functionFragment: "changeJurorNft", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "jurorNft", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "arbitrableWhitelist", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "changeArbitrableWhitelist", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "changeJurorNft", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "jurorNft", data: BytesLike): Result;
...
export interface KlerosCoreNeo extends BaseContract {
    connect(runner?: ContractRunner | null): KlerosCoreNeo;
    waitForDeployment(): Promise<this>;
    interface: KlerosCoreNeoInterface;
    ...
    arbitrableWhitelist: TypedContractMethod<[
        arg0: AddressLike
    ], [
        boolean
    ], "view">;
    ...
    changeArbitrableWhitelist: TypedContractMethod<[
        _arbitrable: AddressLike,
        _allowed: boolean
    ], [
        void
    ...
    changeJurorNft: TypedContractMethod<[
        _jurorNft: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    jurorNft: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "arbitrableWhitelist"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "changeArbitrableWhitelist"): TypedContractMethod<[
        _arbitrable: AddressLike,
        _allowed: boolean
    ], [
        void
    ...
    getFunction(nameOrSignature: "changeJurorNft"): TypedContractMethod<[_jurorNft: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "jurorNft"): TypedContractMethod<[], [string], "view">;
...
//# sourceMappingURL=KlerosCoreNeo.d.ts.map