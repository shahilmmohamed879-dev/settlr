...
export declare namespace KlerosCoreUniversity {
    type RoundStruct = {
...
export interface KlerosCoreUniversityInterface extends Interface {
    getFunction(nameOrSignature: "addNewDisputeKit" | "appeal" | "appealCost" | "appealPeriod" | "arbitrationCost(bytes,address)" | "arbitrationCost(bytes)" | "changeAcceptedFeeTokens" | "changeCourtParameters" | "changeCurrencyRates" | "changeGovernor" | "changeInstructor" | "changeJurorProsecutionModule" | "changePinakion" | "changeSortitionModule" | "convertEthToTokenAmount" | "courts" | "createCourt" | "createDispute(uint256,bytes)" | "createDispute(uint256,bytes,address,uint256)" | "currencyRates" | "currentRuling" | "disputeKits" | "disputes" | "draw" | "enableDisputeKits" | "execute" | "executeGovernorProposal" | "executeRuling" | "getDisputeKitsLength" | "getNumberOfRounds" | "getNumberOfVotes" | "getPnkAtStakePerJuror" | "getRoundInfo" | "getTimesPerPeriod" | "governor" | "initialize" | "instructor" | "isDisputeKitJumping" | "isSupported" | "jurorProsecutionModule" | "passPeriod" | "pinakion" | "proxiableUUID" | "setStake" | "setStakeBySortitionModule" | "sortitionModule" | "transferBySortitionModule" | "upgradeToAndCall" | "version"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AcceptedFeeToken" | "AppealDecision" | "AppealPossible" | "CourtCreated" | "CourtJump" | "CourtModified" | "DisputeCreation" | "DisputeKitCreated" | "DisputeKitEnabled" | "DisputeKitJump" | "Draw" | "Initialized" | "LeftoverRewardSent" | "NewCurrencyRate" | "NewPeriod" | "Ruling" | "TokenAndETHShift" | "Upgraded"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "changeInstructor", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "draw", values: [BigNumberish, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "instructor", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "changeInstructor", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "instructor", data: BytesLike): Result;
...
export interface KlerosCoreUniversity extends BaseContract {
    connect(runner?: ContractRunner | null): KlerosCoreUniversity;
    waitForDeployment(): Promise<this>;
    interface: KlerosCoreUniversityInterface;
    ...
    changeInstructor: TypedContractMethod<[
    ...
    getRoundInfo: TypedContractMethod<[
        ...
        KlerosCoreUniversity.RoundStructOutput
    ], "view">;
    ...
    instructor: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "changeInstructor"): TypedContractMethod<[_instructor: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "instructor"): TypedContractMethod<[], [string], "view">;
...
//# sourceMappingURL=KlerosCoreUniversity.d.ts.map