...
export interface SortitionModuleNeoInterface extends Interface {
    getFunction(nameOrSignature: "changeGovernor" | "changeMaxDrawingTime" | "changeMaxStakePerJuror" | "changeMaxTotalStaked" | "changeMinStakingTime" | "changeRandomNumberGenerator" | "core" | "createDisputeHook" | "createTree" | "delayedStakeReadIndex" | "delayedStakeWriteIndex" | "delayedStakes" | "disputesWithoutJurors" | "draw" | "executeDelayedStakes" | "getJurorBalance" | "getJurorCourtIDs" | "getJurorLeftoverPNK" | "governor" | "initialize" | "initialize4" | "isJurorStaked" | "jurors" | "lastPhaseChange" | "latestDelayedStakeIndex" | "lockStake" | "maxDrawingTime" | "maxStakePerJuror" | "maxTotalStaked" | "minStakingTime" | "notifyRandomNumber" | "passPhase" | "penalizeStake" | "phase" | "postDrawHook" | "proxiableUUID" | "randomNumber" | "randomNumberRequestBlock" | "rng" | "rngLookahead" | "setJurorInactive" | "setStake" | "stakeOf(bytes32,bytes32)" | "stakeOf(address,uint96)" | "totalStaked" | "unlockStake" | "upgradeToAndCall" | "validateStake" | "version" | "withdrawLeftoverPNK"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "changeMaxStakePerJuror", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "changeMaxTotalStaked", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "maxStakePerJuror", values?: undefined): string;
    encodeFunctionData(functionFragment: "maxTotalStaked", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "changeMaxStakePerJuror", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "changeMaxTotalStaked", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "maxStakePerJuror", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "maxTotalStaked", data: BytesLike): Result;
...
export interface SortitionModuleNeo extends BaseContract {
    connect(runner?: ContractRunner | null): SortitionModuleNeo;
    waitForDeployment(): Promise<this>;
    interface: SortitionModuleNeoInterface;
    ...
    changeMaxStakePerJuror: TypedContractMethod<[
        _maxStakePerJuror: BigNumberish
    ], [
        void
    ], "nonpayable">;
    changeMaxTotalStaked: TypedContractMethod<[
    ...
    maxStakePerJuror: TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "changeMaxStakePerJuror"): TypedContractMethod<[
        _maxStakePerJuror: BigNumberish
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "changeMaxTotalStaked"): TypedContractMethod<[_maxTotalStaked: BigNumberish], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "maxStakePerJuror"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "maxTotalStaked"): TypedContractMethod<[], [bigint], "view">;
...
//# sourceMappingURL=SortitionModuleNeo.d.ts.map