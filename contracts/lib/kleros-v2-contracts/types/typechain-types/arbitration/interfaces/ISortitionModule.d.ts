...
export interface ISortitionModuleInterface extends Interface {
    getFunction(nameOrSignature: "createDisputeHook" | "createTree" | "draw" | "getJurorBalance" | "getJurorCourtIDs" | "getJurorLeftoverPNK" | "isJurorStaked" | "lockStake" | "notifyRandomNumber" | "penalizeStake" | "postDrawHook" | "setJurorInactive" | "setStake" | "unlockStake" | "validateStake" | "withdrawLeftoverPNK"): FunctionFragment;
...
export interface ISortitionModule extends BaseContract {
    connect(runner?: ContractRunner | null): ISortitionModule;
    waitForDeployment(): Promise<this>;
    interface: ISortitionModuleInterface;
...
//# sourceMappingURL=ISortitionModule.d.ts.map