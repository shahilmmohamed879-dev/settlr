...
export interface SortitionModuleBaseInterface extends Interface {
...
export interface SortitionModuleBase extends BaseContract {
    connect(runner?: ContractRunner | null): SortitionModuleBase;
    waitForDeployment(): Promise<this>;
    interface: SortitionModuleBaseInterface;
...
//# sourceMappingURL=SortitionModuleBase.d.ts.map