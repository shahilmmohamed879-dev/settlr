...
export interface DisputeKitShutterInterface extends Interface {
    getFunction(nameOrSignature: "LOSER_APPEAL_PERIOD_MULTIPLIER" | "LOSER_STAKE_MULTIPLIER" | "ONE_BASIS_POINT" | "WINNER_STAKE_MULTIPLIER" | "alreadyDrawn" | "areCommitsAllCast" | "areVotesAllCast" | "castCommit" | "castCommitShutter" | "castVote" | "castVoteShutter" | "changeCore" | "changeGovernor" | "core" | "coreDisputeIDToActive" | "coreDisputeIDToLocal" | "createDispute" | "currentRuling" | "disputes" | "draw" | "executeGovernorProposal" | "fundAppeal" | "getCoherentCount" | "getDegreeOfCoherence" | "getFundedChoices" | "getLocalDisputeRoundID" | "getNumberOfRounds" | "getRoundInfo" | "getVoteInfo" | "governor" | "hashVote" | "initialize" | "initialize8" | "isAppealFunded" | "isVoteActive" | "proxiableUUID" | "singleDrawPerJuror" | "upgradeToAndCall" | "version" | "withdrawFeesAndRewards"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "ChoiceFunded" | "CommitCast" | "CommitCastShutter" | "Contribution" | "DisputeCreation" | "Initialized" | "Upgraded" | "VoteCast" | "Withdrawal"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "castCommitShutter", values: [BigNumberish, BigNumberish[], BytesLike, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "castVote", values: [BigNumberish, BigNumberish[], BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "castVoteShutter", values: [BigNumberish, BigNumberish[], BigNumberish, BigNumberish, string]): string;
    ...
    encodeFunctionData(functionFragment: "initialize8", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "castCommitShutter", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "castVote", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "castVoteShutter", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "initialize8", data: BytesLike): Result;
...
export declare namespace CommitCastShutterEvent {
    type InputTuple = [
        _coreDisputeID: BigNumberish,
        _juror: AddressLike,
        _commit: BytesLike,
...
export interface DisputeKitShutter extends BaseContract {
    connect(runner?: ContractRunner | null): DisputeKitShutter;
    waitForDeployment(): Promise<this>;
    interface: DisputeKitShutterInterface;
    ...
    castCommitShutter: TypedContractMethod<[
        _coreDisputeID: BigNumberish,
        _voteIDs: BigNumberish[],
        _commit: BytesLike,
        _identity: BytesLike,
    ...
    castVoteShutter: TypedContractMethod<[
        _coreDisputeID: BigNumberish,
        _voteIDs: BigNumberish[],
        _choice: BigNumberish,
        _salt: BigNumberish,
    ...
    initialize8: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "castCommitShutter"): TypedContractMethod<[
        _coreDisputeID: BigNumberish,
        _voteIDs: BigNumberish[],
        _commit: BytesLike,
        _identity: BytesLike,
    ...
    getFunction(nameOrSignature: "castVoteShutter"): TypedContractMethod<[
        _coreDisputeID: BigNumberish,
        _voteIDs: BigNumberish[],
        _choice: BigNumberish,
        _salt: BigNumberish,
    ...
    getFunction(nameOrSignature: "initialize8"): TypedContractMethod<[], [void], "nonpayable">;
    ...
    getEvent(key: "CommitCastShutter"): TypedContractEvent<CommitCastShutterEvent.InputTuple, CommitCastShutterEvent.OutputTuple, CommitCastShutterEvent.OutputObject>;
    ...
    filters: {
        ...
        "CommitCastShutter(uint256,address,bytes32,bytes32,bytes)": TypedContractEvent<CommitCastShutterEvent.InputTuple, CommitCastShutterEvent.OutputTuple, CommitCastShutterEvent.OutputObject>;
        CommitCastShutter: TypedContractEvent<CommitCastShutterEvent.InputTuple, CommitCastShutterEvent.OutputTuple, CommitCastShutterEvent.OutputObject>;
...
//# sourceMappingURL=DisputeKitShutter.d.ts.map