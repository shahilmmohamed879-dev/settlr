...
export interface DisputeKitSybilResistantInterface extends Interface {
    getFunction(nameOrSignature: "LOSER_APPEAL_PERIOD_MULTIPLIER" | "LOSER_STAKE_MULTIPLIER" | "ONE_BASIS_POINT" | "WINNER_STAKE_MULTIPLIER" | "alreadyDrawn" | "areCommitsAllCast" | "areVotesAllCast" | "castCommit" | "castVote" | "changeCore" | "changeGovernor" | "core" | "coreDisputeIDToActive" | "coreDisputeIDToLocal" | "createDispute" | "currentRuling" | "disputes" | "draw" | "executeGovernorProposal" | "fundAppeal" | "getCoherentCount" | "getDegreeOfCoherence" | "getFundedChoices" | "getLocalDisputeRoundID" | "getNumberOfRounds" | "getRoundInfo" | "getVoteInfo" | "governor" | "hashVote" | "initialize" | "isAppealFunded" | "isVoteActive" | "poh" | "proxiableUUID" | "singleDrawPerJuror" | "upgradeToAndCall" | "version" | "withdrawFeesAndRewards"): FunctionFragment;
...
export interface DisputeKitSybilResistant extends BaseContract {
    connect(runner?: ContractRunner | null): DisputeKitSybilResistant;
    waitForDeployment(): Promise<this>;
    interface: DisputeKitSybilResistantInterface;
    ...
    getFunction(nameOrSignature: "poh"): TypedContractMethod<[], [string], "view">;
...
//# sourceMappingURL=DisputeKitSybilResistant.d.ts.map