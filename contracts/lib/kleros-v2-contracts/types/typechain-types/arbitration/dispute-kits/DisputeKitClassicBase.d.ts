...
export interface DisputeKitClassicBaseInterface extends Interface {
    getFunction(nameOrSignature: "LOSER_APPEAL_PERIOD_MULTIPLIER" | "LOSER_STAKE_MULTIPLIER" | "ONE_BASIS_POINT" | "WINNER_STAKE_MULTIPLIER" | "alreadyDrawn" | "areCommitsAllCast" | "areVotesAllCast" | "castCommit" | "castVote" | "changeCore" | "changeGovernor" | "core" | "coreDisputeIDToActive" | "coreDisputeIDToLocal" | "createDispute" | "currentRuling" | "disputes" | "draw" | "executeGovernorProposal" | "fundAppeal" | "getCoherentCount" | "getDegreeOfCoherence" | "getFundedChoices" | "getLocalDisputeRoundID" | "getNumberOfRounds" | "getRoundInfo" | "getVoteInfo" | "governor" | "hashVote" | "isAppealFunded" | "isVoteActive" | "proxiableUUID" | "singleDrawPerJuror" | "upgradeToAndCall" | "version" | "withdrawFeesAndRewards"): FunctionFragment;
...
export interface DisputeKitClassicBase extends BaseContract {
    connect(runner?: ContractRunner | null): DisputeKitClassicBase;
    waitForDeployment(): Promise<this>;
    interface: DisputeKitClassicBaseInterface;
...
//# sourceMappingURL=DisputeKitClassicBase.d.ts.map