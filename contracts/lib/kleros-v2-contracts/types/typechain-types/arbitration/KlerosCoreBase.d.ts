...
export interface KlerosCoreBase extends BaseContract {
    connect(runner?: ContractRunner | null): KlerosCoreBase;
    waitForDeployment(): Promise<this>;
    interface: KlerosCoreBaseInterface;
...
//# sourceMappingURL=KlerosCoreBase.d.ts.map