...
export interface IPinakionInterface extends Interface {
    getFunction(nameOrSignature: "balanceOf"): FunctionFragment;
    encodeFunctionData(functionFragment: "balanceOf", values: [AddressLike]): string;
    decodeFunctionResult(functionFragment: "balanceOf", data: BytesLike): Result;
}
export interface IPinakion extends BaseContract {
    connect(runner?: ContractRunner | null): IPinakion;
    waitForDeployment(): Promise<this>;
    interface: IPinakionInterface;
...
//# sourceMappingURL=IPinakion.d.ts.map